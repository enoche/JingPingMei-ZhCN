...
\setCJKfamilyfont{ALisu}{LiSu}
\newcommand{\lisu}{\CJKfamily{LiSu}}


\renewcommand{\cftsecfont}{\small \ttfamily}


\title{金瓶梅【崇祯本】}
\author{{\kaisong 兰陵笑笑生} \\ 作者 \and {\kaisong 南洋一粟}\\
编辑\footnote{勘误、排版\LaTeX{}：https://seed-words.github.io/}}
\date{}
...
\usepackage[
paperheight=125mm,   % uncomment for Kindle
paperwidth=100mm,
left=0.02in,
right=0.02in,
top=0.35in,
